class StringUtils:
    ...
    def contains(self, string: str, symbol: str) -> bool:
        ...
        res = False
        try:
            res = string.index(symbol) > -1    #вычисляет индекс найденного символа в строке и присваивает True, если не находит - индекс меньше ноля, и результат остается False
        except ValueError:
            pass
