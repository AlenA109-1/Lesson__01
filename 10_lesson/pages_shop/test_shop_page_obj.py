...
@allure.title('Магазин: расчет суммы товаров в корзине')
@allure.description('Проверка результата расчета суммы товаров в корзине')
@allure.feature('Расчет суммы товаров в корзине')
...
def test_03_shop(driver):
    ...
    driver.quit() # закрытие браузера - по условиям ДЗ

    with allure.step("Сравнить результат вычисления с ожидаемым (58,29)"):
